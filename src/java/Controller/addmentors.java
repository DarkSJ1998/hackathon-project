 ...
 * @author NIKHIL-PC
 */
public class addmentors extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String lpro = request.getParameter("lpro");
        ...
        Mentor u = new Mentor(fname,lname,email,lpro,mobileno,null);
