...
<head>
    ...
    <body background = "sources\carbon2.jpg" style = "background-attachment: fixed;">
        ...
        <div style = "background-image: url('sources/grey-chevron-stripes-1920.png');padding: 0px 20px 20px 20px;">
			<form id = "new-innovator-form" action = "addCorporation" method="POST">
				<fieldset>
					<legend align="center">
						<h1> Create New Corporation Account </h1>
					</legend>
					<center>
					<table>
						<tr>
							...
							<td>
								<input type="text" placeholder="Name" name = "name" id = "name" autofocus required>
							</td>
						</tr>
